...
execute unless score $bullet_type bendangs matches 0 run return run function brmc:game/state/3/next_turn
execute if score $bullet_type bendangs matches 0 unless score $attack_target bendangs = $action_player bendangs run return run function brmc:game/state/3/next_turn
